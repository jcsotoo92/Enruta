 ...
 * {@link Rutas.OnFragmentInteractionListener} interface
...
public class Rutas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RecyclerView recycler = (RecyclerView) v.findViewById(R.id.RecViewRutas);
        AdaptadorRutas card = new AdaptadorRutas();
        recycler.setAdapter(card);
        card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onButtonPressed(recycler.getChildAdapterPosition(v));
            }
        });
    ...
    public void onButtonPressed(int position) {
        if (mListener != null) {
            mListener.onRutasInteraction(position);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        public void onRutasInteraction(int position);
    }
